...
from .views import  PaymentDetailView, SubscriptionDetailView, PricesListView, StripeWebhookView, PaymentMethodView
...
urlpatterns = [
    ...
    path('api/payment_method/<int:pk>/', PaymentMethodView.as_view(), name='payment_method'),
