    ...
    def test_paypal_webhook_success(self, mock_redis_from_url, mock_verify_signature):
        ...
        event = {
            ...
            'resource': {
                ...
                'links': [
                    {'href': 'https://api.sandbox.paypal.com/v1/billing/subscriptions/I-2C054R2S7S33/cancel', 'rel': 'cancel', 'method': 'POST', 'encType': 'application/json'},
                    {'href': 'https://api.sandbox.paypal.com/v1/billing/subscriptions/I-2C054R2S7S33', 'rel': 'edit', 'method': 'PATCH', 'encType': 'application/json'},
                    {'href': 'https://api.sandbox.paypal.com/v1/billing/subscriptions/I-2C054R2S7S33', 'rel': 'self', 'method': 'GET', 'encType': 'application/json'},
                    {'href': 'https://api.sandbox.paypal.com/v1/billing/subscriptions/I-2C054R2S7S33/suspend', 'rel': 'suspend', 'method': 'POST', 'encType': 'application/json'},
                    {'href': 'https://api.sandbox.paypal.com/v1/billing/subscriptions/I-2C054R2S7S33/capture', 'rel': 'capture', 'method': 'POST', 'encType': 'application/json'}
                ],
                'id': 'I-2C054R2S7S33',
            ...
            'links': [
                {'href': 'https://api.sandbox.paypal.com/v1/notifications/webhooks-events/WH-4JX204663A8287931-6LX68303T63222804', 'rel': 'self', 'method': 'GET'},
                {'href': 'https://api.sandbox.paypal.com/v1/notifications/webhooks-events/WH-4JX204663A8287931-6LX68303T63222804/resend', 'rel': 'resend', 'method': 'POST'}
            ]
        }
