...
class PaymentMethodViewTests(APITestCase):
    ...
    def test_post_payment_method(self):
        ...
        self.assertIn(created_payment_method_id, [pm['id'] for pm in all_payment_methods])
    ...
    # Test setup: Create a new Visa card payment method
        ...
        response = self.client.put(self.url, {'payment_method_id': visa_payment_method_id['payment_method_id']}, HTTP_AUTHORIZATION=f'Bearer {self.access}', format='json')
        self.assertEqual(response.status_code, 200)
        ...
        self.assertEqual(default_payment_method_id, visa_payment_method_id['payment_method_id'])
        ...
        response = self.client.put(self.url, {'payment_method_id': mc_payment_method_id['payment_method_id']}, HTTP_AUTHORIZATION=f'Bearer {self.access}', format='json')
        self.assertEqual(response.status_code, 200)
        ...
        if isinstance(default_payment_method_id, dict):
            default_payment_method_id = default_payment_method_id.get('id')
        self.assertEqual(default_payment_method_id, mc_payment_method_id['payment_method_id'])
    ...
    def test_get_payment_methods(self):
        ...
        response = self.client.put(self.url, {'payment_method_id': default_payment_method_id}, HTTP_AUTHORIZATION=f'Bearer {self.access}', format='json')
        self.assertEqual(response.status_code, 200)
    ...
    def test_delete_payment_method(self):
        ...
        response = self.client.delete(self.url, {'payment_method_id': default_payment_method_id}, HTTP_AUTHORIZATION=f'Bearer {self.access}', format='json')
        self.assertEqual(response.status_code, 200)
        ...
        self.assertIsNone(data['default_payment_method'])  # Verify the default payment method is None
        self.assertIsInstance(data['all_payment_methods'], list)  # Verify all_payment_methods is a list
